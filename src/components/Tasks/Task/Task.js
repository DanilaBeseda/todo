         ...
         <div className={classes.item}>
            ...
            {!isLoading
               ? <div className={classes.btns}>
                  {!isEdit
                     ? <>
                        <button className={classes.edit} onClick={editTask}>
                        ...
                        <button className={classes.remove} onClick={() => removeTask(listId, task.id)}>
                     ...
                     : <button className={classes.confirm} onClick={() => confirmEditTask(listId, task.id)}>
